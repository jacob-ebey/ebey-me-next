...
We are going to personnalize this simple login page image on desktop by replacing it with a webpack federated
react component.
...
button was not known about by the origin application. There also is zero
